...
import com.advaitpatel.goweather.adapter.ForecastOverviewAdapter;
...
public class DailyForecastActivity extends BaseActivity {
    ...
    public void downloadJSON() {
         ...
         * Get settings
         */
        city = SharedPreferences.getString("location", "Chicago");
        CountryCode = SharedPreferences.getString("countrykey", "US");
