...
import com.advaitpatel.goweather.search.SearchSugestionProvider;
...
public class MainActivity extends BaseActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch (Integer.parseInt(prefs.getString("theme", "1"))){
            case 1:
        ...
        client.get("http://api.openweathermap.org/data/2.5/forecast/daily?q=" + city + "," + CountryCode + "&units=" + unit + "&lang=" + language + "&cnt=3&APPID=" + ApiKey, new AsyncHttpResponseHandler() {
            ...
            public void onFailure(int statusCode, Header[] headers, byte[] errorResponse, Throwable e) {
                ...
                if (!retried) {
                    ...
                    Snackbar
                            .make(coordinatorLayoutView, "Try again after sometime", Snackbar.LENGTH_LONG)
            ...
            public void onRetry(int retryNo) {
                Toast.makeText(MainActivity.this, "New Request " + retryNo, Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id == R.id.action_share){
            if (downloadSucessfull){
                String sharebody = "Weather for " + city + ", " + CountryCode + ": " + WeatherHelper.getDescription() + " \n" +
                        "At the same time " + String.format("%.1f", WeatherHelper.getTemperature_max()) + "°";
